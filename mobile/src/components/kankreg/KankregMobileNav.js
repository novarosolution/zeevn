...
/** Full-screen premium mobile menu — web phone / narrow viewports. */
export default function KankregMobileNav({
  ...
  const exiting = reducedMotion ? undefined : FadeOut.duration(180);
  ...
  return (
    <View style={styles.portal} pointerEvents="box-none">
      ...
      <Animated.View
        entering={reducedMotion ? undefined : FadeInDown.duration(320).springify().damping(22)}
        exiting={exiting}
        style={[
          styles.sheet,
          panelShadow,
...
const styles = StyleSheet.create({
  ...
  ctaBtn: {
    ...
    overflow: "hidden",
    ...platformShadow({
      web: { boxShadow: "0 12px 28px rgba(22, 69, 51, 0.28)" },
      ios: {
        shadowColor: "#1a1208",
