...
export const HOME_HERO_APP_HEIGHT_RATIO = 0.48;
export const HOME_HERO_APP_MAX_HEIGHT = 272;
export const HOME_HERO_APP_MIN_HEIGHT = 200;
...
export const HOME_HERO_PRODUCT_PHONE_SLIDE_HEIGHT_PER_WIDTH = 1844 / 853;
