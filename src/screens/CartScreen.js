...
function createCartStyles(c, shadowLift, shadowPremium, isDark) {
  ...
  selectionCard: {
    ...
    borderTopWidth: 3,
    borderTopColor: isDark ? "rgba(248, 113, 113, 0.4)" : "rgba(220, 38, 38, 0.56)",
    marginBottom: spacing.md,
    overflow: "hidden",
    ...shadowPremium,
    ...Platform.select({
  ...
  sizeBadge: {
    alignSelf: "flex-start",
    backgroundColor: isDark ? c.surfaceMuted : c.frostTint || "#FFF",
  ...
  upsellSection: {
    ...
    borderTopWidth: 2,
    borderTopColor: isDark ? "rgba(248, 113, 113, 0.38)" : "rgba(220, 38, 38, 0.5)",
    padding: spacing.md,
